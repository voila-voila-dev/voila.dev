					...
					<Popover.Trigger
						render={
							<Button
								...
								className={cx(
									"flex min-h-10 h-auto items-center justify-between rounded-md border p-1",
							...
							<div className="flex w-full items-center justify-between">
										...
										.map((value) => {
											...
											return (
												...
												>
													...
													<span className={cx(screenSize === "mobile" && "truncate")}>
														{option.label}
													</span>
													<div
														role="button"
														...
														className={cx(
															"-m-0.5 ml-2 h-4 w-4 cursor-pointer rounded-sm p-0.5",
															"hover:bg-white/20",
								...
								<div className="flex items-center justify-between">
									<div
										...
										className={cx(
											"mx-2 flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm",
